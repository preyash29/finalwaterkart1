...
import { rootLoader, addCommunityBooking, communityBookingSetting } from '../../../actions'
...
class Community extends React.Component {
  ...
  async componentDidMount() {
    ...
    let res = await communityBookingSetting()
  ...
  _submit = async () => {
    ...
    this.props.rootLoader(true)
    let res = await this.props.addCommunityBooking(requestParams)
    this.props.rootLoader(false)
    setTimeout(() => {
        ...
        >
          ...
          <View style={{ marginHorizontal: 20 }}>
            ...
            <View style={[styles.row, { justifyContent: 'space-between', marginTop: 10 }]}>
              ...
              <TouchableOpacity
                style={{ padding: 10, alignItems: 'center' }}
                onPress={() => this._openList(settings?.app_url)}
              >
