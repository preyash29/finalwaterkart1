    ...
    render() {
        return (
            <View style={styles.root}>
                <FlatList
                    data={this.props.closedServices}
    ...
    renderItem = ({ item }) => {
        return (
            ...
            >
                ...
                <Text style={styles.serviceTitle}>closed date:  {moment(new Date(item?.visit_date)).format('DD MMMM YYYY')}</Text>
                </View>
            </TouchableOpacity>
        )
    }
...
function mapStateToProps({ user }) {
    return {
        closedServices: user.closedServices
    }
}
